...
void Automatico(){
  ...
  if (FlagArranqueAuto == true && flagCNE == true){
    digitalWrite(Forward,HIGH);
    ledcWrite(2, 180);
  } 
...
void Nort(){
  ...
  if (((Ndeg[0] >= 0 &&  Ndeg[0] <= 10) ||  (Ndeg[0] <= 360 &&  Ndeg[0] >= 335)) && (flagSU == false)){
    if (flagPOS == true){
      flagPOS = false;
      n = 0;
    }
  ...
  if ((Ndeg[0] > 10 && Ndeg[0] < 180) && ((flagSU == false))){
      myservo.write(115);
  }
  if ((Ndeg[0] >= 180 && Ndeg[0] < 350) && (flagSU == false)){
    myservo.write(45);
  }
}
...
void East(){
  Serial.println("Este");
  if (((Ndeg[0] >= 75 &&  Ndeg[0] <= 110)) && (flagSU == false)){
    if (flagPOS == true){
      flagPOS = false;
      n = 0;
    }
  ...
  if (((Ndeg[0] >= 0 &&  Ndeg[0] < 75) ||  (Ndeg[0] <= 360 &&  Ndeg[0] >= 270)) && ((flagSU == false))){
    myservo.write(45);
  }
  if ((Ndeg[0] > 110 && Ndeg[0] < 270) && ((flagSU == false))){
      myservo.write(115);
  }
}
...
void South(){
  Serial.println("Sur");
  if (((Ndeg[0] >= 170 &&  Ndeg[0] <= 200)) && (flagSU == false)){
    if (flagPOS == true){
      flagPOS = false;
      n = 0;
    }
  ...
  if ((Ndeg[0] >= 0 &&  Ndeg[0] < 170) && (flagSU == false)){
    myservo.write(45);
  }
  if ((Ndeg[0] > 200 && Ndeg[0] <= 360) && ((flagSU == false))){
      myservo.write(115);
  }
}
...
void West(){
  Serial.println("Este");
  if (((Ndeg[0] >= 260 &&  Ndeg[0] <= 280)) && (flagSU == false)){
    if (flagPOS == true){
      flagPOS = false;
      n = 0;
    }
  ...
  if ((Ndeg[0] >= 90 &&  Ndeg[0] < 260) && (flagSU == false)){
    myservo.write(45);
  }
  if (((Ndeg[0] >= 0 &&  Ndeg[0] < 90 ) ||  (Ndeg[0] <= 360 &&  Ndeg[0] > 280)) && ((flagSU == false))){
      myservo.write(115);
  }
}
